...
//
// libtabnasbnf is the bnf format parser as a C shared library, one of
...
import (
	...
	plug "github.com/tabnas/bnf/go"
	host "github.com/tabnas/parser/go"
)

const (
	templateVersion = "v4"
	libName         = "libtabnasbnf"
	formatName      = "bnf"
	valueOut        = true
...
// newParser builds one engine with the bnf grammar installed
...
// parseWith answers whether src is in the bnf language — and,
