...
//
// Vale is the other half and runs in ci/workflows/docs.yml. The two
...
describe('docs-style', () => {
  ...
  // A page can be reader-facing and still be wrong to gate: these four
  // are another repository's documentation, copied and never rewritten,
  // so a clean Vale run over them would certify the wrong content. The
  // debt stays visible -- each entry exists, is excluded, names a reason,
  // and is listed in the guide -- so it cannot go quiet.
